          ...
          <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-9 col-xs-12">
                <div class="x_panel">
				<form action= "ORG_PreAct_AForm2.html" method="submit">
				<div class="x_content">
					...
					<span class="section">General Information</span>
                        ...
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="title">Title of Activity: </label>
							<input type="text" id="title" class="col-md-3 col-sm-3 col-xs-9" placeholder="Enter the title of the activity" name="title" required />
						</div>
						<br />
						<br />
						<div class="item form-group">
						<label class="control-label col-md-2 col-sm-2 col-xs-12" for="gosm[]">Part of GOSM: </label>
                        <input type="radio" name="gosm[]" id="op1" value="Venue" required class="flat"/> Yes
                        <br />
                        <input type="radio" name="gosm[]" id="op2" value="dateandtime" class="flat"/> No

					<br />
					<br />					
					<span class="section">Nature of Activity</span>
						<div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="csoandspecialgroups">CSO and Special Groups: </label>
						...
						<br />
						<div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="usg">USG: </label>
					...
					<span class="section">Type of Activity</span>	
						<div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="throughcsodaam">Through CSO / DAAM: </label>
						...
						<br />
						<div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="throughslife">Through Slife: </label>
