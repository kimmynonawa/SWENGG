              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_content">
                    ...
                    <form class="form-inline form-label-left" id="foodlistform">
                          ...
                          <table class="table table-bordered">
                            ...
                            <tbody id="tr">
                              <tr>
                                ...
                                <td align= "center"><input type="number" name= "funit" class="form-control" id="funit"/></td>
                    ...
                    <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-12 col-md-offset-11">
                          <button id="nextbff2" type="submit" class="btn btn-success align: right">Next</button>
                        </div>
                      </div>
