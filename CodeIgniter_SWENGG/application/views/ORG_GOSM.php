                ...
                <div class="x_panel">
					...
					<span class="section">Activities</span>
						<div class="form-group">
							<label class="control-label col-md-2 col-sm-2 col-xs-12" for="typeofcampusaccess">Activity: </label>
								<select id="typeofcampusaccess" required class="col-md-4 col-sm-4 col-xs-9">
								<option value="default">Select Activity</option>
								<option value="leadershipseminar">Leadership Seminar</option>
								<option value="generalassembly">General Assembly</option>
								<option value="teambuilding">Team building</option>
								<option value="distributionofcards">YES Distribution of Cards</option>
							</select>
						</div>
