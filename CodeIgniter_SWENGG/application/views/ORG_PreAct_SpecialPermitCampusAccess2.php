                          ...
                          <div class= "form-group col-md-12">
                            <table class="table table-striped">
                              ...
                              <tbody id="names">
                                ...
                                <td>  <input class="form-control" name="lName[]" placeholder ="Enter Last Name" required/></td>
                                <td>  <input class="form-control" name="fName[]" placeholder ="Enter First Name" required/></td>
                                <td>  <input class="form-control" name="mName[]" placeholder ="Enter Middle Name" required/></td>
                                <td>  <input class="form-control" name="classification[]" placeholder ="Enter Classifcation" required/></td>
                                <td>  <input class="form-control" name="email[]" placeholder ="Enter Email" required/></td>
                                <td>  <input class="form-control" name="mNum[]" placeholder ="Enter Mobile Number" required/></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
