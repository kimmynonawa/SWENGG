                          ...
                          <div class= "form-group col-md-12">
                            <table class="table table-striped">
                              ...
                              <tbody id="requests">
                                ...
                                <td>  <input class="form-control" name="sdate[]" type="date" placeholder ="Enter Start Date" required/></td>
                                <td>  <input class="form-control" name="stime[]" type="date" placeholder ="Enter End Date" required/></td>
                                <td>  <input class="form-control" name="edate[]" type="time" placeholder ="Enter Start Time" required/></td>
                                <td>  <input class="form-control" name="etime[]" type="time" placeholder ="Enter End Time" required/></td>
                                <td>  <input class="form-control" name="venue[]" placeholder ="Enter Venue" required/></td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
