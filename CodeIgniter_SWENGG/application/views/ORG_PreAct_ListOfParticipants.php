                    ...
                    <table class="table table-striped">
                      ...
                      <tbody id="student">
                          <tr id ="details" class="details">
                            ...
                            <td>  <input class="form-control" name = "age" placeholder ="Enter Age" style ="width:120px" required/></td>
                        ...
                        <!--
                        <div id="student" class = "form-inline">
                            <table>
                                <th> ID NUMBER </th>
                                <th> LAST NAME </th>
                                <th> FIRST NAME</th>
                              ...
                              <tbody>
                                <tr>
                                  <td>  <input class="form-control" placeholder ="Enter ID Number" required/></td>
                                  <td>  <input class="form-control" placeholder ="Enter Last Name" required/></td>
                                  <td>  <input class="form-control" placeholder ="Enter First Name" required/></td>
                                  <td>  <input class="form-control" placeholder ="Enter Middle Initial" required/></td>
                                  <td>  <input class="form-control" placeholder ="Enter Age" style="width:110px" required/></td>
                                  <td>  <h4>&nbsp&nbsp  WAIVER: <input type="checkbox" class="js-switch" checked /></h4></td>
                                </tr>
                              </tbody>
                            </table>    

                            
                            <div id = "details" class="form-group details">
                              <br>
                              <input class="form-control" placeholder ="ID Number" required/>
                              <input class="form-control" placeholder ="Last Name" required/>
                              <input class="form-control" placeholder ="First Name" required/>
                              <input class="form-control" placeholder ="Middle Initial" required/>
                              <input class="form-control" placeholder ="Age" style="width:150px" required/>
                              <label> WAIVER:
