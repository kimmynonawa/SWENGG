				...
				<div class="x_content">
					...
					<span class="section">General Information</span>
                        ...
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="date">Date: </label>
							<input type="date" id="date" class="col-md-4 col-sm-4 col-xs-9" placeholder="Enter the date for equipment entry" name="date" required />
						</div>
                        ...
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Name: </label>
							<input type="text" id="name" class="col-md-4 col-sm-4 col-xs-9" placeholder="Enter the name of the requesting party" name="name" required />
						</div>
						
						<br />
						<br />
						<div class="item form-group">
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="position">Position: </label>
							<input type="text" id="position" class="col-md-4 col-sm-4 col-xs-9" placeholder="Enter the position of the requesting party" name="position" required />
						</div>
						
						<br />
						<br />
						<div class="item form-group">
							<label class="control-label col-md-2 col-sm-2 col-xs-12" for="body">Body: </label>
							<textarea id="body" required="required" name="body" placeholder="Enter body for requesting equipment entry permit" class="col-md-4 col-sm-4 col-xs-9" data-parsley-trigger="keyup" data-parsley-validation-threshold="10"></textarea>
						</div>
