        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>View Special Approval Slip</h3>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                           ...
                           <div class="item form-group">
                                <label class="control-label col-md-3">Type of Submission:</label>
                                <?php 
									foreach($groups as $row)
									{ 
										echo $row->sastype;
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3">Justification:</label>
                               <?php 
									foreach($groups as $row)
									{ 
					...
					<li ><a href="http://localhost/index.php/DownloadPreacts/saspdf">View Printable Form</a></li>
                    </div>
                </div> 
            </div>
        </div> 
