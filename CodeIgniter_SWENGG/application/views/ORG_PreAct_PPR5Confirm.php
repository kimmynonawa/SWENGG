                ...
                <div class="x_panel">
                  <div class="x_content">
                    <form class=" form-label-left" method="post">
                     <div class= "row">
                        <div class="col-md-8">   
                          <label class= "col-md-3"> <h4> May Income Ba Puta </h4> </label>
                            <div class= "form-group col-md-7">
                              <input type="radio" value="yes" name= "yesno" class="flat"/> <label> Yes</label>
                              <input type="radio" value="no" name= "yesno" class="flat"/> <label>No </label>
                            </div>        
                        </div>
