                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="item form-group">
							<?php if ($cad[0]['cancellation'] == 1):?> 
                                <label class="control-label col-md-3">Changes:</label>
                                <p>Cancellation</p>
							<?php endif;?> 
							
							<?php if (isset($cadvenue)):?> 
                                <label class="control-label col-md-3">New Venue:</label>
                                <p><?php echo $cadvenue[0]['newvenue']?></p>
							<?php endif;?> 
							
							<?php if (isset($cadedate)):?> 
                                <?php for ($i =0; $i<count($aformdate); $i++):?>
                            <div class="item form-group">
                                <label class="control-label col-md-3">Date and Time :</label>
                                <p><?php 
									$fromdate = $cadedate[$i]['newstartdate'];
									$fromdatenew = strtotime($fromdate);
									$formatted_fromdate = date('F d, Y', $fromdatenew);
									echo $formatted_fromdate;
									if($aformdate[$i]['enddate'] != Null){
										echo " - ";
										$fromdate = $aformdate[$i]['newenddate'];
										$fromdatenew = strtotime($fromdate);
										$formatted_fromdate = date('F d, Y', $fromdatenew);
										echo $formatted_fromdate;
									}
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3"></label>
                                <p> <?php echo $aformdate[$i]['newstarttime']?> - <?php echo $aformdate[$i]['newendtime']?></p>
                            </div> 
							<?php endfor;?>
							<?php endif;?> 
                            </div> 
                        </div>
						<li><a href="http://localhost/index.php/DownloadPreacts/cad">View Printable Form</a><li>
                    </div>
                </div> 
            </div>
        </div> 
