        ...
        <div class="">
            ...
            <div class="x_panel">
                <div class="row">
					...
					<li ><a href="http://localhost/index.php/DownloadPreacts/aform">View Printable Form</a></li>
                </div> 
            </div>
        </div> 
        <!-- /page content -->
