                ...
                <div class="x_panel">
                  ...
                  <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group" style="height:60px">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name"> Type of Activity <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" list ="actOptions" id="first-name" required="required" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group" align="center">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success" id="submit" a href="ORG_Home.html">Submit</button>
                        </div>
                      </div>
      ...
      <script>
        $(document).ready(function () {
            $("#submit").click(function () {
              window.location.href = "ORG_PreAct_AForm.html";
            })
        })
    </script>
  </body>
